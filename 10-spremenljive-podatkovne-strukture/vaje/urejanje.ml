...
let rec min_and_rest = function
    ...
    | x :: xs -> 
        ...
        in
        Some (get_min x [] xs)
(*Če nekaj vrne None more nekaj vrniti Some!*)
...
let selection_sort_array a = 
    ...
    let rec sorter lower =
        ...
        (* Find the minimal element in the rest of the list and swap it with the element on line 
        | lower end of the 'to be sorted' part of the list . *)
